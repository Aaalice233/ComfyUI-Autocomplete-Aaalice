...
const TEXT = {
    en: {
        ...
        open: "Open manager",
        description: "Scan tags missing from the Hugging Face base CSV, then optionally translate them with DeepSeek.",
        ...
        translationDescription: "Tune throughput and cost for the current interface language.",
    ...
    zh: {
        title: "Danbooru 实时标签",
        open: "打开管理面板",
        description: "扫描 Hugging Face 基础表中缺失的标签，并可选择使用 DeepSeek 翻译。",
        overview: "同步概览",
        categories: "类别筛选",
        ...
        translationDescription: "为当前界面语言设置吞吐量与成本参数。",
        advanced: "高级提示词",
        policy: "拉取策略",
        thresholdValue: "最低热度",
        allHint: "包含全部标签",
    ...
    "zh-TW": {
        title: "Danbooru 即時標籤",
        open: "開啟管理面板",
        description: "掃描 Hugging Face 基礎表中缺少的標籤，並可選擇使用 DeepSeek 翻譯。",
        overview: "同步概覽",
        categories: "類別篩選",
        ...
        translationDescription: "為目前介面語言設定吞吐量與成本參數。",
        advanced: "進階提示詞",
        policy: "擷取策略",
        thresholdValue: "最低熱度",
        allHint: "包含全部標籤",
    ...
    ja: {
        ...
        open: "管理画面を開く",
        description: "Hugging Face の基本 CSV にないタグを取得し、必要に応じて DeepSeek で翻訳します。",
        overview: "同期サマリー",
        ...
        translationDescription: "現在の表示言語に合わせて処理量とコストを調整します。",
        advanced: "詳細プロンプト",
        policy: "取得方法",
