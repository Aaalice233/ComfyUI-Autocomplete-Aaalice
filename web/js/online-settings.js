...
const TEXT = {
    en: {
        ...
        dictionaryDescription: "Managed from ffdkj as a local translation fallback for both Chinese interfaces and for Simplified Chinese-to-English tag autocomplete.",
    ...
    zh: {
        ...
        dictionaryDescription: "数据来自 ffdkj，为简体与繁体中文界面提供本地标签汉化，并支持简体中文反查英文 Tag。",
    ...
    "zh-TW": {
        ...
        dictionaryDescription: "資料來自 ffdkj，為簡體與繁體中文介面提供本機標籤翻譯，並支援簡體中文反查英文 Tag。",
    ...
    ja: {
        ...
        dictionaryDescription: "ffdkj が提供し、中国語 UI のローカル翻訳と簡体字中国語から英語タグへの補完に使用します。",
...
export async function openOnlineServicesPanel(_app) {
    ...
    links.append(
        externalLink("GitHub", PROJECT_URL, "github"),
        externalLink("Discord", DISCORD_URL, "discord"),
    );
