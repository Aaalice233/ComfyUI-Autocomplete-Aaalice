...
describe('runtime UI localization', () => {
    ...
    test.each(['en', 'zh', 'zh-TW', 'ja'])('contains every runtime key for %s', locale => {
        for (const key of [
            ...
            'translatingTag',
            'similarity',
            'autocompleteHeaderTitle',
            'autocompleteHeaderQueryLabel',
            'autocompleteHeaderResultCount',
            'autocompleteHeaderHint',
            'autocompleteClose',
            'relatedTagsClose',
            'autocompleteFooterAriaLabel',
            'autocompleteCooccurrenceLabel',
            'autocompleteCooccurrenceReady',
            'autocompleteCooccurrenceLoading',
            'autocompleteCooccurrenceWaiting',
            'autocompleteCooccurrenceError',
            'autocompleteDictionaryLabel',
            'autocompleteDictionaryReady',
            'autocompleteDictionaryDownloading',
            'autocompleteDictionaryChecking',
            'autocompleteDictionaryMissing',
            'autocompleteDictionaryError',
            'autocompleteDictionaryUpdate',
            'autocompleteKeyLabel',
            'autocompleteKeyConfigured',
            'autocompleteKeyNotConfigured',
            'autocompleteDanbooruLabel',
            'autocompleteDanbooruReady',
            'autocompleteDanbooruWaiting',
            'autocompleteDanbooruError',
            'autocompleteStatusChecking',
            'autocompleteStatusError',
            'autocompleteOpenOnlineSettings',
        ]) {
